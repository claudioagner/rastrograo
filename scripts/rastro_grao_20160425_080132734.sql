...
-- Started on 2016-04-25 08:01:33
...
ALTER TABLE ONLY public.propriedade DROP CONSTRAINT fkf063c7095a71537b;
ALTER TABLE ONLY public.acesso_empresas DROP CONSTRAINT fked3713dd0bbfd8d;
ALTER TABLE ONLY public.acesso_empresas DROP CONSTRAINT fked3713d2eb83573;
ALTER TABLE ONLY public.responsavel_empresa DROP CONSTRAINT fkdd30958ad0bbfd8d;
ALTER TABLE ONLY public.responsavel_empresa DROP CONSTRAINT fkdd30958a9a70f730;
ALTER TABLE ONLY public.foto_empresa DROP CONSTRAINT fkc6a9b04ed0bbfd8d;
ALTER TABLE ONLY public.acesso_regra DROP CONSTRAINT fkbd057670c922d881;
ALTER TABLE ONLY public.acesso_regra DROP CONSTRAINT fkbd0576702eb83573;
ALTER TABLE ONLY public.estado DROP CONSTRAINT fkb2e439662542c05b;
ALTER TABLE ONLY public.cidade DROP CONSTRAINT fkaee65724e42c143b;
ALTER TABLE ONLY public.telefone_propriedade DROP CONSTRAINT fka2ad81344cd6868d;
ALTER TABLE ONLY public.empresa DROP CONSTRAINT fk9f3540895a71537b;
ALTER TABLE ONLY public.certificacao_empresa DROP CONSTRAINT fk84a6fdb5ec8cf724;
ALTER TABLE ONLY public.certificacao_empresa DROP CONSTRAINT fk84a6fdb5d0bbfd8d;
ALTER TABLE ONLY public.foto_talhao_propriedade DROP CONSTRAINT fk72c2287cf916efde;
ALTER TABLE ONLY public.responsavel_propriedade DROP CONSTRAINT fk66bab38a9a70f730;
ALTER TABLE ONLY public.responsavel_propriedade DROP CONSTRAINT fk66bab38a4cd6868d;
ALTER TABLE ONLY public.foto_propriedade DROP CONSTRAINT fk64e0cc4e4cd6868d;
ALTER TABLE ONLY public.acesso_propriedades DROP CONSTRAINT fk4f4693d4cd6868d;
ALTER TABLE ONLY public.acesso_propriedades DROP CONSTRAINT fk4f4693d2eb83573;
ALTER TABLE ONLY public.telefone_empresa DROP CONSTRAINT fk4f30c834d0bbfd8d;
ALTER TABLE ONLY public.certificacao_propriedade DROP CONSTRAINT fk1f1b0e35ec8cf724;
ALTER TABLE ONLY public.certificacao_propriedade DROP CONSTRAINT fk1f1b0e354cd6868d;
ALTER TABLE ONLY public.talhao_propriedade DROP CONSTRAINT fk184db5614cd6868d;
ALTER TABLE ONLY public.tipo_responsavel DROP CONSTRAINT tipo_responsavel_pkey;
ALTER TABLE ONLY public.tipo_certificacao DROP CONSTRAINT tipo_certificacao_pkey;
ALTER TABLE ONLY public.telefone_propriedade DROP CONSTRAINT telefone_propriedade_pkey;
ALTER TABLE ONLY public.telefone_propriedade DROP CONSTRAINT telefone_propriedade_numero_telefone_propriedade_ddd_propri_key;
ALTER TABLE ONLY public.telefone_empresa DROP CONSTRAINT telefone_empresa_pkey;
ALTER TABLE ONLY public.telefone_empresa DROP CONSTRAINT telefone_empresa_numero_telefone_empresa_ddd_empresa_empres_key;
ALTER TABLE ONLY public.talhao_propriedade DROP CONSTRAINT talhao_propriedade_pkey;
ALTER TABLE ONLY public.responsavel_propriedade DROP CONSTRAINT responsavel_propriedade_pkey;
ALTER TABLE ONLY public.responsavel_propriedade DROP CONSTRAINT responsavel_propriedade_numero_telefone_responsavel_proprie_key;
ALTER TABLE ONLY public.responsavel_empresa DROP CONSTRAINT responsavel_empresa_pkey;
ALTER TABLE ONLY public.responsavel_empresa DROP CONSTRAINT responsavel_empresa_numero_telefone_responsavel_empresa_ddd_key;
ALTER TABLE ONLY public.regra DROP CONSTRAINT regra_pkey;
ALTER TABLE ONLY public.regra DROP CONSTRAINT regra_authority_key;
ALTER TABLE ONLY public.propriedade DROP CONSTRAINT propriedade_pkey;
ALTER TABLE ONLY public.permissao DROP CONSTRAINT permissao_url_key;
ALTER TABLE ONLY public.permissao DROP CONSTRAINT permissao_pkey;
ALTER TABLE ONLY public.pais DROP CONSTRAINT pais_pkey;
ALTER TABLE ONLY public.foto_talhao_propriedade DROP CONSTRAINT foto_talhao_propriedade_pkey;
ALTER TABLE ONLY public.foto_propriedade DROP CONSTRAINT foto_propriedade_pkey;
ALTER TABLE ONLY public.foto_empresa DROP CONSTRAINT foto_empresa_pkey;
ALTER TABLE ONLY public.estado DROP CONSTRAINT estado_pkey;
ALTER TABLE ONLY public.empresa DROP CONSTRAINT empresa_pkey;
ALTER TABLE ONLY public.cidade DROP CONSTRAINT cidade_pkey;
ALTER TABLE ONLY public.certificacao_propriedade DROP CONSTRAINT certificacao_propriedade_pkey;
ALTER TABLE ONLY public.certificacao_empresa DROP CONSTRAINT certificacao_empresa_pkey;
ALTER TABLE ONLY public.audit_log_event DROP CONSTRAINT audit_log_event_pkey;
ALTER TABLE ONLY public.acesso_regra DROP CONSTRAINT acesso_regra_pkey;
ALTER TABLE ONLY public.acesso_propriedades DROP CONSTRAINT acesso_propriedades_pkey;
ALTER TABLE ONLY public.acesso DROP CONSTRAINT acesso_pkey;
ALTER TABLE ONLY public.acesso_empresas DROP CONSTRAINT acesso_empresas_pkey;
ALTER TABLE public.tipo_responsavel ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.tipo_certificacao ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.telefone_propriedade ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.telefone_empresa ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.talhao_propriedade ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.responsavel_propriedade ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.responsavel_empresa ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.regra ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE public.foto_talhao_propriedade ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.foto_propriedade ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.foto_empresa ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.estado ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.empresa ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.cidade ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.certificacao_propriedade ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.certificacao_empresa ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.audit_log_event ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.acesso ALTER COLUMN id DROP DEFAULT;
DROP SEQUENCE public.tipo_responsavel_id_seq;
DROP TABLE public.tipo_responsavel;
DROP SEQUENCE public.tipo_certificacao_id_seq;
DROP TABLE public.tipo_certificacao;
DROP SEQUENCE public.telefone_propriedade_id_seq;
DROP TABLE public.telefone_propriedade;
DROP SEQUENCE public.telefone_empresa_id_seq;
DROP TABLE public.telefone_empresa;
DROP SEQUENCE public.talhao_propriedade_id_seq;
DROP TABLE public.talhao_propriedade;
DROP SEQUENCE public.responsavel_propriedade_id_seq;
DROP TABLE public.responsavel_propriedade;
DROP SEQUENCE public.responsavel_empresa_id_seq;
DROP TABLE public.responsavel_empresa;
DROP SEQUENCE public.regra_id_seq;
...
DROP SEQUENCE public.foto_talhao_propriedade_id_seq;
DROP TABLE public.foto_talhao_propriedade;
DROP SEQUENCE public.foto_propriedade_id_seq;
DROP TABLE public.foto_propriedade;
DROP SEQUENCE public.foto_empresa_id_seq;
DROP TABLE public.foto_empresa;
...
DROP SEQUENCE public.certificacao_propriedade_id_seq;
DROP TABLE public.certificacao_propriedade;
DROP SEQUENCE public.certificacao_empresa_id_seq;
DROP TABLE public.certificacao_empresa;
DROP SEQUENCE public.audit_log_event_id_seq;
DROP TABLE public.audit_log_event;
DROP TABLE public.acesso_regra;
DROP TABLE public.acesso_propriedades;
DROP SEQUENCE public.acesso_id_seq;
DROP TABLE public.acesso_empresas;
DROP TABLE public.acesso;
DROP EXTENSION plpgsql;
DROP SCHEMA public;
--
-- TOC entry 7 (class 2615 OID 89519)
...
-- Completed on 2016-04-25 08:01:37
