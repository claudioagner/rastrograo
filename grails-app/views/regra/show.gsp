		...
		<div id="show-regra" class="content scaffold-show" role="main">
			...
			<ol class="property-list regra">
				...
				<li class="fieldcontain">
					<span id="authority-label" class="property-label"><g:message code="regra.authority.label" default="Authority" /></span>
						...
						<span class="property-value" aria-labelledby="authority-label">${regraInstance?.encodeAsHTML()}</span>
			...
			<g:form>
				<fieldset class="buttons">
					<g:hiddenField name="id" value="${regraInstance?.id}" />
					<g:link class="edit" action="edit" id="${regraInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
