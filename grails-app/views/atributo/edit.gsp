...
<html>
	...
	<body>
		<a href="#edit-atributo" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-atributo" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${atributoInstance?.version}" />
				<fieldset class="form">
